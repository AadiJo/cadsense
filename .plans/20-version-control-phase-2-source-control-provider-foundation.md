...
- review threads/comments/diffs: key by provider CR ID and head SHA/version when available; fetch on demand for CadSense Review
...
## CadSense Review Design Constraint
...
- The provider API includes the review operations needed by future CadSense Review work, even if they are capability-gated.
