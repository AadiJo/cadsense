...
export function deriveTimelineEntries(
  ...
  reviewsOrWorkEntries: CadReviewReport[] | WorkLogEntry[],
  maybeWorkEntries?: WorkLogEntry[],
): TimelineEntry[] {
  const reviews = maybeWorkEntries ? (reviewsOrWorkEntries as CadReviewReport[]) : [];
  const workEntries = maybeWorkEntries ?? (reviewsOrWorkEntries as WorkLogEntry[]);
