...
import { parseScopedThreadKey, scopedThreadKey } from "@cadsense/client-runtime";
import { type ScopedThreadRef, type TerminalEvent } from "@cadsense/contracts";
...
const TERMINAL_STATE_STORAGE_KEY = "cadsense:terminal-state:v1";
