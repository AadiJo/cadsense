  ...
  return (
    <SidebarInstanceContext value={instanceContextValue}>
      ...
      >
        ...
        <div
          className={cn(
            "relative w-(--sidebar-width) bg-transparent transition-[width] duration-180 ease-[cubic-bezier(0.2,0.86,0.22,1.08)]",
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-180 ease-[cubic-bezier(0.2,0.86,0.22,1.08)] md:flex",
            side === "left"
