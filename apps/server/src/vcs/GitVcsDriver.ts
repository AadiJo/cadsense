...
export const makeVcsDriverShape = Effect.fn("makeGitVcsDriverShape")(function* () {
  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      const tempIndexPath = path.join(gitCommonDir, `cadsense-checkpoint-index-${randomUUID()}`);
      const commitEnv: NodeJS.ProcessEnv = {
        ...process.env,
        GIT_INDEX_FILE: tempIndexPath,
        GIT_AUTHOR_NAME: "CadSense",
        GIT_AUTHOR_EMAIL: "cadsense@users.noreply.github.com",
        GIT_COMMITTER_NAME: "CadSense",
        GIT_COMMITTER_EMAIL: "cadsense@users.noreply.github.com",
      };
      ...
      yield* Effect.gen(function* () {
        ...
        const message = `cadsense checkpoint ref=${input.checkpointRef}`;
