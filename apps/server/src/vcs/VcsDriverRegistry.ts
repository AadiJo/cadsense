...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@cadsense/contracts";
import { VcsUnsupportedOperationError } from "@cadsense/contracts";
...
export class VcsDriverRegistry extends Context.Service<VcsDriverRegistry, VcsDriverRegistryShape>()(
  "cadsense/vcs/VcsDriverRegistry",
) {}
