...
import { SourceControlProviderError, type ChangeRequest } from "@cadsense/contracts";
...
export const makeDiscovery = Effect.fn("makeBitbucketSourceControlProviderDiscovery")(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set CADSENSE_BITBUCKET_EMAIL and CADSENSE_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request and repository scopes).",
