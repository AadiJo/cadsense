...
function isMissingGitHubCliProviderError(error: SourceControlProviderError): boolean {
      ...
      if (input.state === "open") {
        return github
          ...
          .pipe(
            ...
            Effect.catchIf(isMissingGitHubCliProviderError, () => Effect.succeed([])),
          );
      }
