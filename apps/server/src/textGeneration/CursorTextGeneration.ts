...
import { type CursorSettings, type ModelSelection } from "@cadsense/contracts";
import { sanitizeBranchFragment, sanitizeFeatureBranchName } from "@cadsense/shared/git";
import { extractJsonObject } from "@cadsense/shared/schemaJson";
  ...
  const runCursorJson = <S extends Schema.Top>({
    ...
    Effect.gen(function* () {
      ...
      const runtime = yield* makeCursorAcpRuntime({
        ...
        cwd,
        clientInfo: { name: "cadsense-git-text", version: "0.0.0" },
      });
