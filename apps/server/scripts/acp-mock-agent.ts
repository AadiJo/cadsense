...
const requestLogPath = process.env.CADSENSE_ACP_REQUEST_LOG_PATH;
const exitLogPath = process.env.CADSENSE_ACP_EXIT_LOG_PATH;
const emitToolCalls = process.env.CADSENSE_ACP_EMIT_TOOL_CALLS === "1";
const emitInterleavedAssistantToolCalls =
  process.env.CADSENSE_ACP_EMIT_INTERLEAVED_ASSISTANT_TOOL_CALLS === "1";
const emitGenericToolPlaceholders = process.env.CADSENSE_ACP_EMIT_GENERIC_TOOL_PLACEHOLDERS === "1";
const emitAskQuestion = process.env.CADSENSE_ACP_EMIT_ASK_QUESTION === "1";
const failSetConfigOption = process.env.CADSENSE_ACP_FAIL_SET_CONFIG_OPTION === "1";
const exitOnSetConfigOption = process.env.CADSENSE_ACP_EXIT_ON_SET_CONFIG_OPTION === "1";
const promptResponseText = process.env.CADSENSE_ACP_PROMPT_RESPONSE_TEXT;
