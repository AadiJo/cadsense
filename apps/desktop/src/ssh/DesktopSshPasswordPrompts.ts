import type { DesktopSshPasswordPromptRequest } from "@cadsense/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@cadsense/contracts";
import type { SshPasswordRequest } from "@cadsense/ssh/auth";
...
const WINDOW_UNAVAILABLE_MESSAGE = "CadSense window is not available for SSH authentication.";
...
>()("cadsense/desktop/SshPasswordPrompts") {}
