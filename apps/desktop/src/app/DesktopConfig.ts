...
export const DesktopConfig = Config.all({
  ...
  devRemoteCadSenseServerEntryPath: trimmedString("CADSENSE_DEV_REMOTE_CADSENSE_SERVER_ENTRY_PATH"),
  configuredBackendPort: Config.port("CADSENSE_PORT").pipe(Config.option),
  commitHashOverride: trimmedString("CADSENSE_COMMIT_HASH"),
  desktopLanHostOverride: trimmedString("CADSENSE_DESKTOP_LAN_HOST"),
  desktopHttpsEndpointUrls: commaSeparatedStrings("CADSENSE_DESKTOP_HTTPS_ENDPOINTS"),
