...
const startup = Effect.gen(function* () {
  ...
  // Chromium may blocklist WebGL1 on some GPUs (logged as `WebGL1 blocklisted`); the CAD viewer
  // needs WebGL. Safe default for a desktop IDE surface — matches common Electron app practice.
  yield* electronApp.appendCommandLineSwitch("ignore-gpu-blocklist");
