...
export interface DesktopEnvironmentShape {
  ...
  readonly devRemoteCadSenseServerEntryPath: Option.Option<string>;
...
const makeDesktopEnvironment = Effect.fn("desktop.environment.make")(function* (
  ...
  const baseDir = Option.getOrElse(config.cadsenseHome, () =>
    path.join(homeDirectory, ".cadsense"),
  );
  ...
  return DesktopEnvironment.of({
    ...
    devServerUrl,
    devRemoteCadSenseServerEntryPath: config.devRemoteCadSenseServerEntryPath,
    ...
    branding,
    displayName,
    appUserModelId: isDevelopment ? "com.cadsense.cadsense.dev" : "com.cadsense.cadsense",
