import type { VcsStatusRemoteResult, VcsStatusResult } from "@cadsense/contracts";
...
describe("normalizeGitRemoteUrl", () => {
  it("canonicalizes equivalent GitHub remotes across protocol variants", () => {
    expect(normalizeGitRemoteUrl("git@github.com:CadSense/CadSense.git")).toBe(
      "github.com/cadsense/cadsense",
    );
    expect(normalizeGitRemoteUrl("https://github.com/CadSense/CadSense.git")).toBe(
      "github.com/cadsense/cadsense",
    );
    expect(normalizeGitRemoteUrl("ssh://git@github.com/CadSense/CadSense")).toBe(
      "github.com/cadsense/cadsense",
    );
  });

  it("preserves nested group paths for providers like GitLab", () => {
    expect(normalizeGitRemoteUrl("git@gitlab.com:CadSense/platform/CadSense.git")).toBe(
      "gitlab.com/cadsense/platform/cadsense",
    );
    expect(normalizeGitRemoteUrl("https://gitlab.com/CadSense/platform/CadSense.git")).toBe(
      "gitlab.com/cadsense/platform/cadsense",
    );
  });
...
describe("parseGitHubRepositoryNameWithOwnerFromRemoteUrl", () => {
  it("extracts the owner and repository from common GitHub remote shapes", () => {
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("git@github.com:CadSense/CadSense.git"),
    ).toBe("CadSense/CadSense");
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("https://github.com/CadSense/CadSense.git"),
    ).toBe("CadSense/CadSense");
  });
});
