...
import { ExternalProjectContext, ExternalThreadContext } from "./onshape.ts";
import {
  ApprovalRequestId,
  CheckpointRef,
  CommandId,
...
export const OrchestrationProject = Schema.Struct({
  ...
  externalContext: Schema.optional(Schema.NullOr(ExternalProjectContext)),
...
export type CadReviewStatus = typeof CadReviewStatus.Type;

export const CadReviewPriority = Schema.Literals(["critical", "high", "medium", "low"]);
export type CadReviewPriority = typeof CadReviewPriority.Type;

export const CadReviewEvidenceArtifact = Schema.Struct({
  id: TrimmedNonEmptyString,
  scope: Schema.Literals(["baseline", "persona"]),
  persona: Schema.optional(CadReviewPersona),
  viewName: TrimmedNonEmptyString,
  artifactUri: TrimmedNonEmptyString,
  mimeType: Schema.optional(TrimmedNonEmptyString),
  status: Schema.Literals(["captured", "failed"]),
  error: Schema.optional(Schema.String),
  createdAt: IsoDateTime,
});
export type CadReviewEvidenceArtifact = typeof CadReviewEvidenceArtifact.Type;

export const CadReviewToolCall = Schema.Struct({
  id: TrimmedNonEmptyString,
  persona: CadReviewPersona,
  phase: TrimmedNonEmptyString,
  toolName: TrimmedNonEmptyString,
  argumentsSummary: Schema.optional(Schema.String),
  resultSummary: Schema.optional(Schema.String),
  evidenceArtifactIds: Schema.Array(TrimmedNonEmptyString).pipe(
...
export type CadReviewToolCall = typeof CadReviewToolCall.Type;

export const CadReviewFinding = Schema.Struct({
  id: TrimmedNonEmptyString,
  title: TrimmedNonEmptyString,
...
export const CadReviewActionItem = Schema.Struct({
  id: TrimmedNonEmptyString,
  title: TrimmedNonEmptyString,
  description: Schema.String,
  subsystem: Schema.optional(TrimmedNonEmptyString),
...
export const CadReviewPersonaReport = Schema.Struct({
  ...
  summary: Schema.String,
  topConcerns: Schema.Array(CadReviewFinding),
  positiveSignals: Schema.Array(Schema.String).pipe(Schema.withDecodingDefault(Effect.succeed([]))),
  repeatedPatterns: Schema.Array(Schema.String),
  likelyFailureModes: Schema.Array(Schema.String),
  recommendedChanges: Schema.Array(Schema.String),
  confidence: Schema.Literals(["low", "medium", "high"]),
  missingEvidence: Schema.optional(Schema.String),
  evidenceArtifactIds: Schema.Array(TrimmedNonEmptyString),
  toolCallIds: Schema.Array(TrimmedNonEmptyString),
  error: Schema.optional(Schema.String),
  createdAt: IsoDateTime,
  updatedAt: IsoDateTime,
});
...
export type CadReviewReport = typeof CadReviewReport.Type;
...
export const OrchestrationThread = Schema.Struct({
  ...
  reviews: Schema.optional(Schema.Array(CadReviewReport)),
...
export const ThreadReviewGenerateCommand = Schema.Struct({
  type: Schema.Literal("thread.review.generate"),
  commandId: CommandId,
  threadId: ThreadId,
...
const ThreadReviewUpsertCommand = Schema.Struct({
  type: Schema.Literal("thread.review.upsert"),
  commandId: CommandId,
  threadId: ThreadId,
...
export type ThreadReviewUpsertedPayload = typeof ThreadReviewUpsertedPayload.Type;
...
export const OrchestrationEvent = Schema.Union([
  ...
  Schema.Struct({
    ...EventBaseFields,
    type: Schema.Literal("thread.review-upserted"),
    payload: ThreadReviewUpsertedPayload,
  }),
  Schema.Struct({
    ...EventBaseFields,
